...
public class ChatRepository : BaseRepository<Chat>, IChatRepository
{
    ...
    public async Task<Chat?> GetByIdWithMessagesAsync(Guid id, int page = 1, int pageSize = 20)
    {
        return await _dbSet
            .Include(c => c.Tutor)
    ...
    public async Task<IEnumerable<Chat>> GetUserChatsAsync(Guid userId, int page = 1, int pageSize = 20)
    {
        return await _dbSet
            .Include(c => c.Tutor)
            .ThenInclude(t => t!.User)
